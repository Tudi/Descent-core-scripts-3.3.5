...
//object set - get extension functions
//!!!!!!!!!! these are leaking memory since there is no 100% when to delete the variable holders 
...
//int luaObject_AddExtensionUInt64(lua_State * L, Object * ptr);	//no idea how to use lua 64 bit variable :S
//int luaObject_GetExtensionUInt64(lua_State * L, Object * ptr);
