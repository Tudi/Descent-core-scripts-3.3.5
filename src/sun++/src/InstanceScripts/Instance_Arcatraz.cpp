...
public:
    ...
    ZerekethAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		if(_unit->GetMapMgr()->instance_difficulty != INSTANCE_MODE_RAID_25_MAN_HEROIC)
		{
    ...
    void OnDied(Unit * mKiller)
    {
		...
		set<Object*>::iterator itr,itr2;
		for(itr2 = _unit->GetInRangeSetBegin(); itr2 != _unit->GetInRangeSetEnd();)
		{
			itr = itr2;
			itr2++;
...
public:
	...
	void OnCombatStart(Unit* mTarget)
	{
		...
		sEventMgr.AddEvent(static_cast< Object* >(_unit), &Object::PlaySoundToSet, (uint32)11223, EVENT_UNK, 27000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
	...
	void AIUpdate()
	{
		...
		else if( IsTimerFinished(Phase_Timer) && Phase==1 )
		{
			...
			else if( Phasepart == 1 )
			{
				...
				{
					Unit *millhouse = (Unit*)(ForceCreatureFind(MILLHOUSE_MANASTORM));
					if ( millhouse )
					{
						sEventMgr.AddEvent(static_cast< Unit* >(millhouse), &Unit::SendChatMessage, (uint8)CHAT_MSG_MONSTER_YELL, (uint32)LANG_UNIVERSAL,  
						...
						sEventMgr.AddEvent(static_cast< Object* >(millhouse), &Object::PlaySoundToSet, (uint32)11171, EVENT_UNK, 2000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
						...
						sEventMgr.AddEvent(static_cast< Object* >(_unit), &Object::PlaySoundToSet, (uint32)11226, EVENT_UNK, 13000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
						...
						sEventMgr.AddEvent(static_cast< Object* >(millhouse), &Object::PlaySoundToSet, (uint32)11172, EVENT_UNK, 22000, 1, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
					}
					Phase = 2;
					Phasepart = 0;
