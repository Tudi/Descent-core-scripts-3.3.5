...
public:
	...
	void OnCombatStop(Unit *mTarget)
	{
		...
		_unit->SafeDelete();
		_unit = NULL; //hmmm, can we even do this ?
	}
...
class ChessAI : public MoonScriptCreatureAI
{
public: MOONSCRIPT_FACTORY_FUNCTION(ChessAI, MoonScriptCreatureAI);
		ChessAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
		{
		}
};
...
class ChessHordeAI : public MoonScriptCreatureAI
{
public:
	MOONSCRIPT_FACTORY_FUNCTION(ChessHordeAI, MoonScriptCreatureAI);

	ChessHordeAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
	{
	}
	void OnDied(Unit *pKiller)
	{
...
class ChessAllianceAI : public MoonScriptCreatureAI
{
public:
	MOONSCRIPT_FACTORY_FUNCTION(ChessAllianceAI, MoonScriptCreatureAI);

	ChessAllianceAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
	{
	}
	void OnDied(Unit *pKiller)
	{	
...
class ChessPieceAI : public MoonScriptCreatureAI
{
public:
	MOONSCRIPT_FACTORY_FUNCTION(ChessPieceAI, MoonScriptCreatureAI);

	ChessPieceAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
	{
	}
	void OnDied(Unit *pKiller)
	{
...
void SetupKarazhan(ScriptMgr* pScriptMgr)
{
	...
	*/
	...
	// Zack : OMG forcing pointer type casts !!!
