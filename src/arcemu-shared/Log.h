...
#define MAX_USABLE_SPELL_ID	65535
#define LOG_LAST_N_SPELLS 100
	extern uint8		casted_spells[MAX_USABLE_SPELL_ID];
	extern uint32		next_dump;
	extern uint32		filename_index;
	extern uint32		last_N_spells[LOG_LAST_N_SPELLS];
	extern uint32		last_N_spells_index;
	extern FILE			*last_N_spells_FILE;
	void DumpToFileUniqueSpells( bool forced = false);
#endif
