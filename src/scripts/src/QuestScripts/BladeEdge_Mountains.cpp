...
public:
	...
	void OnActivate(Player * pPlayer)
	{
		...
		{
			if(obelisk1->GetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE) == 0 && obelisk2->GetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE) == 0 && obelisk3->GetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE) == 0 && obelisk4->GetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE) == 0 && obelisk5->GetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE) == 0)
			{
	...
	void ResetGO(Player* plr)
	{
		...
		obelisk1->SetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE,1);
		obelisk2->SetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE,1);
		obelisk3->SetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE,1);
		obelisk4->SetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE,1);
		obelisk5->SetByte(GAMEOBJECT_BYTES_1,GAMEOBJECT_BYTES_STATE,1);
	}
};
