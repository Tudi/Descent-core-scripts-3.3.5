...
(20, 'Announcer', 'hear me !', '', 0, 7, 0, 0, 0, 0, 12679, 0, 0, 0, 2, 1, NULL, 0);
...
(20, 96, 96, 35, 100000, 100000, 0, 0.25, 0, 1000, 0, 100, 200, 0, 0, 0, 360000000, 100000, 100000, 100000, 100000, 100000, 100000, 100000, 1.8, 0.5, '0', 0, 0, 0, 0, 2.5, 8, 14, 0, 0, 0, 0, 0, 0, 0);
*/
...
#define ANNOUNCE_INTERVAL					(5*60*1000)      //X milliseconds
