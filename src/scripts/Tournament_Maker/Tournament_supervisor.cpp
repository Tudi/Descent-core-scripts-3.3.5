...
{
	CharacterDatabase.Query("UPDATE tournament_team_settings SET matches_finished = matches_finished + 1 WHERE tournament_id='%u' and id='%u'", cur_tournament_id,Team1Info.id);
}

void Tournament_Supervisor::Event_team2_loose()
{
	CharacterDatabase.Query("UPDATE tournament_team_settings SET matches_finished = matches_finished + 1 WHERE tournament_id='%u' and id='%u'", cur_tournament_id,Team2Info.id);
}
void Tournament_Supervisor::Event_team1_win()
{
	CharacterDatabase.Query("UPDATE tournament_team_settings SET matches_finished = matches_finished + 1,matches_won = matches_won + 1, matches_won_total = matches_won_total + 1 WHERE tournament_id='%u' and id='%u'", cur_tournament_id,Team1Info.id);
}
void Tournament_Supervisor::Event_team2_win()
{
	CharacterDatabase.Query("UPDATE tournament_team_settings SET matches_finished = matches_finished + 1,matches_won = matches_won + 1, matches_won_total = matches_won_total + 1 WHERE tournament_id='%u' and id='%u'", cur_tournament_id,Team2Info.id);
}
void Tournament_Supervisor::Event_team1_kick()
{
	CharacterDatabase.Query("UPDATE tournament_team_settings SET matches_finished = 999999 WHERE tournament_id='%u' and id='%u'", cur_tournament_id,Team1Info.id);
}
void Tournament_Supervisor::Event_team2_kick()
{
	CharacterDatabase.Query("UPDATE tournament_team_settings SET matches_finished = 999999 WHERE tournament_id='%u' and id='%u'", cur_tournament_id,Team2Info.id);
}
