...
struct dmg_storage_struct
{
	uint32	base_min,base_max;
	int32	pct_mod_add;
	int32	flat_mod_add;
};
...
SERVER_DECL void CalculateDamage( Unit* pAttacker, Unit* pVictim, uint32 weapon_damage_type, uint32 *spellgroup, SpellEntry* ability, dmg_storage_struct &ret);
