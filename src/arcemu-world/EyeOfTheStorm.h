...
//	int32 m_CPStatus[EOTS_TOWER_COUNT];	
	tr1::array< int32, EOTS_TOWER_COUNT> m_CPStatus;
	uint32 m_flagHolder;
	...
	tr1::array< GameObject *, EOTS_TOWER_COUNT> m_CPStatusGO;
	tr1::array< GameObject *, EOTS_TOWER_COUNT> m_CPBanner;
	tr1::array< GameObject *, 2> m_bubbles;
	tr1::array< GameObject *, 4> EOTSm_buffs;
	tr1::array< GameObject *, EOTS_TOWER_COUNT> m_CPBanner2;
	tr1::array< GameObject *, EOTS_TOWER_COUNT> m_CPBanner3;

	typedef set<Player*> EOTSCaptureDisplayList;
	//EOTSCaptureDisplayList m_CPDisplay[EOTS_TOWER_COUNT];
	tr1::array< EOTSCaptureDisplayList, EOTS_TOWER_COUNT > m_CPDisplay;

	//uint32 m_lastHonorGainPoints[2];
	tr1::array< uint32, 2> m_lastHonorGainPoints;
	//uint32 m_points[2];
	tr1::array< uint32, 2> m_points;
	//Creature * m_spiritGuides[EOTS_TOWER_COUNT];
	tr1::array<Creature *,EOTS_TOWER_COUNT> m_spiritGuides;
};
