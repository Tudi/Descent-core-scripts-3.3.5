...
void GossipScript::GossipHello(Object* pObject, Player* Plr, bool AutoSend)
{
		...
		Plr->getLevel() > 10 )						  // player level
	{
		...
		{
			Menu->AddMenuItem(0, "Purchase a Dual Talent Specialization.",0,0,"Are you sure you would like to purchase your second talent specialization?",10000000,0,15);
		}
	}
