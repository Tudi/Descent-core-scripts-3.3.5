...
WorldPacket* WorldSession::BuildQuestQueryResponse(Quest *qst)
{
	...
	*data << uint32(qst->unk_33_3);
	*data << uint32(qst->unk_33_4);
...
void QuestLogEntry::HackComplete()
{
	...
	if ( m_quest->reward_money < 0 && m_plr->GetGold( ) < uint32(-m_quest->reward_money) )
	{
		...
		m_plr->Event_Achiement_Received( ACHIEVEMENT_CRITERIA_TYPE_MONEY_FROM_QUEST_REWARD,ACHIEVEMENT_UNUSED_FIELD_VALUE,ACHIEVEMENT_UNUSED_FIELD_VALUE,m_quest->reward_money,ACHIEVEMENT_EVENT_ACTION_ADD);
	}
...
{
	m_plr->Event_Achiement_Received(ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUEST,m_quest->id,ACHIEVEMENT_UNUSED_FIELD_VALUE,1,ACHIEVEMENT_EVENT_ACTION_ADD);
	m_plr->Event_Achiement_Received(ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUEST_COUNT,ACHIEVEMENT_UNUSED_FIELD_VALUE,ACHIEVEMENT_UNUSED_FIELD_VALUE,1,ACHIEVEMENT_EVENT_ACTION_ADD);
	m_plr->Event_Achiement_Received(ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUESTS_IN_ZONE,m_plr->GetZoneId(),ACHIEVEMENT_UNUSED_FIELD_VALUE,1,ACHIEVEMENT_EVENT_ACTION_ADD);
	if( m_quest->is_repeatable == arcemu_QUEST_REPEATABLE_DAILY )
	{
		...
		m_plr->Event_Achiement_Received(ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_DAILY_QUEST_DAILY,ACHIEVEMENT_UNUSED_FIELD_VALUE,ACHIEVEMENT_UNUSED_FIELD_VALUE,1,ACHIEVEMENT_EVENT_ACTION_ADD);
		m_plr->Event_Achiement_Received(ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_DAILY_QUEST,ACHIEVEMENT_UNUSED_FIELD_VALUE,ACHIEVEMENT_UNUSED_FIELD_VALUE,1,ACHIEVEMENT_EVENT_ACTION_ADD);
	}
	WorldPacket data(4);
