...
enum Opcodes {
    ...
    CMSG_LFG_PLAYER_LOCK_INFO_REQUEST               = 0x36E,    // CMSG RequestLFDPlayerLockInfo
    ...
    SMSG_CONTROL_VECHICLE					        = 0x49D, // not changed 9626
    ...
    CMSG_ENTER_VEHICLE                              = 0x4A8, // cmsg uint64
    ...
    SMSG_ITEM_REFUND_INFO_RESPONSE                  = 0x4B2, // refund something
