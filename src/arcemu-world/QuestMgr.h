...
public:
	...
	void OnPlayerKill(Player* plr, uint32 victim_entry, bool IsGroupKill);
	...
	void TryAutoAcceptQuest(WorldSession *sess, uint64 &quest_giver_guid, uint32 quest_id);
	...
	ARCEMU_INLINE bool IsQuestWeekly(Quest *qst) { return (qst->is_repeatable==3 ? true : false); }
