...
void WorldSession::HandleQuestgiverStatusQueryOpcode( WorldPacket & recv_data )
{
	...
	uint64 guid;
	sStackWolrdPacket( data, SMSG_QUESTGIVER_STATUS, 50 );
...
void WorldSession::HandleQuestlogRemoveQuestOpcode(WorldPacket& recvPacket)
{
	...
	GetPlayer()->Event_Achiement_Received( ACHIEVEMENT_CRITERIA_TYPE_QUEST_ABANDONED,ACHIEVEMENT_UNUSED_FIELD_VALUE,ACHIEVEMENT_UNUSED_FIELD_VALUE,1,ACHIEVEMENT_EVENT_ACTION_ADD);
}
