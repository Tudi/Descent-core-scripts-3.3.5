...
void CommandTableStorage::Init()
{
	...
	static ChatCommand debugCommandTable[] =
	{
		...
		{ "targetcast",          'd', &ChatHandler::HandleTargtCastCommand,        ".targetcast <spellid> - Force targt to cast a spell without cast condition checks",                                 NULL, 0, 0, 0 },
		...
		{ "genclasstrianer",     'd', &ChatHandler::HandleGenClassTrainer,         "generate spells that can be learned in theory by trainer. DBC might be bugged",                                                                                                                  NULL, 0, 0, 0 },
		{ NULL,                  '0', NULL,                                        "",                                                                                                                  NULL, 0, 0, 0 }
	};
...
//		{ "spawnlink",        'n', &ChatHandler::HandleNpcSpawnLinkCommand,   ".spawnlink sqlentry",                                                                                                                     NULL, 0, 0, 0 },
	...
	static ChatCommand characterCommandTable[] =
	{
		...
		{ "setcustomtitle",		 'm', &ChatHandler::HandleSetTitleCustom,		   "Adds a custom title to a player",																					NULL, 0, 0, 0 },
		{ NULL,                  '0', NULL,                                        "",                                                                                                                  NULL, 0, 0, 0 }
	};
	...
	static ChatCommand commandTable[] =
	{
		...
		{ "spelldisableadd", 'm', &ChatHandler::HandleSpellDisableAddCommand,               "",                                                                                                                                        NULL,                     0, 0, 0 },
		{ "spelldisableremove", 'm', &ChatHandler::HandleSpellDisableRemoveCommand,               "",                                                                                                                                        NULL,                     0, 0, 0 },
		...
		//level 1 commands
		{ "char_settitle",		'k', &ChatHandler::HandleSetTitle,				"Adds title to a player",														NULL, 0, 0, 0 },
		...
		{ "guild_disband",		'k', &ChatHandler::HandleGuildDisbandCommand,		"Disbands the guild of your target.",										NULL, 0, 0, 0 },
		{ "npc_morph",          'k', &ChatHandler::HandleMorphCommand,              "Change the model of the target. Use :.npc_morph <model_id> ",                                                                                                            NULL,                     0, 0, 0 },
		...
		{ "npc_equip1",			'k', &ChatHandler::HandleNPCEquipOneCommand,		"Use: .npc equip1 <itemid> - use .npc equip1 0 to remove the item",         NULL, 0, 0, 0 },
		{ "npc_equip2",			'k', &ChatHandler::HandleNPCEquipTwoCommand,		"Use: .npc equip2 <itemid> - use .npc equip2 0 to remove the item",         NULL, 0, 0, 0 },
		{ "npc_equip3",			'k', &ChatHandler::HandleNPCEquipThreeCommand,		"Use: .npc equip3 <itemid> - use .npc equip3 0 to remove the item",         NULL, 0, 0, 0 },
		{ "cheat_triggerpass",	'k', &ChatHandler::HandleTriggerpassCheatCommand,	"Ignores area trigger prerequisites.",										NULL, 0, 0, 0 },
		{ "char_unmute",		'k', &ChatHandler::HandleAccountUnmuteCommand,		"Unmutes account <x>",														NULL, 0, 0, 0 },
		{ "char_mute",			'k', &ChatHandler::HandleAccountMuteCommand,		"Mutes account for <timeperiod>.",                                 NULL, 0, 0, 0 },
		{ "realm_IP_mute",		'k', &ChatHandler::HandleIPMuteCommand,				"Mutes IP realm wide for <timeperiod>.",                                 NULL, 0, 0, 0 },
		{ "realm_IP_unmute",	'k', &ChatHandler::HandleIPUnmuteCommand,			"Unmutes IP realm wide <x>",                                             NULL, 0, 0, 0 },
		...
		{ "char_removeitem",    'k', &ChatHandler::HandleRemoveItemCommand,			"Removes item %u count %u.",                                                NULL, 0, 0, 0 },
		{ "kick_byplayer",		'k', &ChatHandler::HandleKillByPlayerCommand,		"Disconnects the player with name <s>.",									NULL, 0, 0, 0 },
		{ "kick_byaccount",		'k', &ChatHandler::HandleKillBySessionCommand,		"Disconnects the session with account name <s>.",							NULL, 0, 0, 0 },
		{ "kick_byip",			'k', &ChatHandler::HandleKillByIPCommand,			"Disconnects the session with the ip <s>.",									NULL, 0, 0, 0 },
		{ "ban_character",		'k', &ChatHandler::HandleBanCharacterCommand,		"Bans character x with or without reason",                                  NULL, 0, 0, 0 },
...
uint32 GetSpellPrevRank(SpellEntry *sp)
{
	...
	for(uint32 x=0; x < dbcSkillLineSpell.GetNumRows(); x++)
	{
		...
		if( !spt || spt->NameHash != sp->NameHash || spt->baseLevel >= sp->baseLevel || (int32)spt->baseLevel < smaller_bigest )
			continue;
		smaller_bigest = spt->baseLevel;
		best_id = spt->Id;
	}
	return best_id;
}
