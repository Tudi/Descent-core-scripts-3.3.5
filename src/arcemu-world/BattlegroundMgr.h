...
//	list<uint32> m_queuedPlayers[BATTLEGROUND_NUM_TYPES][MAX_LEVEL_GROUP];
	tr1::array< tr1::array<list<uint32>,MAX_LEVEL_GROUP>,BATTLEGROUND_NUM_TYPES> m_queuedPlayers;

	// Instance Id -> list<Group id> [BattlegroundType][LevelGroup]
//	list<uint32> m_queuedGroups[BATTLEGROUND_NUM_TYPES];
	tr1::array<list<uint32>,BATTLEGROUND_NUM_TYPES > m_queuedGroups;
...
//	uint32 m_deltaRating[2];
	tr1::array<uint32,2> m_deltaRating;
	uint32 m_invisGMs;
...
//	set<Player*> m_players[2];
	tr1::array< set<Player*>,2 > m_players;
