...
protected:
	...
	bool HandleKickHomeCommand(const char* args, WorldSession *m_session);
	...
	bool HandleSetTitleCustom(const char *args, WorldSession *m_session);
	...
	bool HandleLearnSkillineCommand(const char* args, WorldSession *m_session);
	...
	bool HandleGMTicketListEventTelCommand(const char* args, WorldSession *m_session);
	...
	bool HandleTargtCastCommand(const char* args, WorldSession *m_session);
	...
	bool HandleSpellDisableAddCommand(const char* args, WorldSession *m_session);
	bool HandleSpellDisableRemoveCommand(const char* args, WorldSession *m_session);
	...
	bool HandleSetVehicleEntry(const char* args, WorldSession* m_session);
	bool HandleSetVehicleSpell(const char* args, WorldSession* m_session);
	bool HandleGenClassTrainer(const char* args, WorldSession* m_session);
	...
	bool HandleGetValueCommand(const char* args, WorldSession* m_session);
	...
	bool HandleIPMuteCommand(const char * args, WorldSession * m_session);
	bool HandleIPUnmuteCommand(const char * args, WorldSession * m_session);
...
//	SkillNameMgr *SkillNameManager;
	...
	bool HandleGOAnimate(const char * args, WorldSession * m_session);
