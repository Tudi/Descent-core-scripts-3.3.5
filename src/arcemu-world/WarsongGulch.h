...
class WarsongGulch : public CBattleground
{
	...
	tr1::array< GameObject *, 6 > m_buffs;
	tr1::array< GameObject *, 2 > m_homeFlags;
	tr1::array< GameObject *, 2 > m_dropFlags;
	tr1::array< uint32, 2 > m_flagHolders;
	list<GameObject*> m_gates;
	//uint32 m_scores[2];
	tr1::array< uint32 , 2 > m_scores;
	uint32 m_lgroup;
public:
